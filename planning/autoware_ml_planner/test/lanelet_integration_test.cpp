...
using autoware::ml_planner::convert_to_internal_lanelet_map;
...
protected:
  void SetUp() override
  {
    ...
    const std::string package_name = "autoware_ml_planner";
...
{
  using autoware::ml_planner::POINTS_PER_SEGMENT;

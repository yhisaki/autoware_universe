...
#ifndef AUTOWARE__DIFFUSION_PLANNER__INFERENCE__GUIDANCE__UTILS_HPP_
#define AUTOWARE__DIFFUSION_PLANNER__INFERENCE__GUIDANCE__UTILS_HPP_
...
std::vector<float> create_delta_from_denormalized_trajectories(
  ...
  const std::vector<std::vector<Eigen::Vector2d>> & guided_trajectories, float x_std,
  float y_std);

}  // namespace autoware::diffusion_planner

#endif  // AUTOWARE__DIFFUSION_PLANNER__INFERENCE__GUIDANCE__UTILS_HPP_

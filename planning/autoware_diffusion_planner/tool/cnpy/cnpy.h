...
#ifndef PLANNING__AUTOWARE_DIFFUSION_PLANNER__TOOL__CNPY__CNPY_H_
#define PLANNING__AUTOWARE_DIFFUSION_PLANNER__TOOL__CNPY__CNPY_H_
  ...
  std::string mode = "w")
{
  ...
  global_header +=
    static_cast<uint32_t>(global_header_offset);  // relative offset of local file header
  global_header += fname;
...
#endif  // PLANNING__AUTOWARE_DIFFUSION_PLANNER__TOOL__CNPY__CNPY_H_

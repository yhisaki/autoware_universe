...
#ifndef AUTOWARE__DIFFUSION_PLANNER__PREPROCESSING__INPUT_BUILDER_HPP_
#define AUTOWARE__DIFFUSION_PLANNER__PREPROCESSING__INPUT_BUILDER_HPP_
...
#include "autoware/diffusion_planner/preprocessing/message_view.hpp"
 ...
 * same InputDataMap, whether filled online from subscriptions or offline from
 * a rosbag.
 */
struct FrameInputs
{
...
using InputDataResult = tl::expected<InputDataMap, std::string>;
...
InputDataResult create_input_data_map(
  ...
  std::vector<SelectedAgent> * selected_agents_out = nullptr);

}  // namespace preprocess
}  // namespace autoware::diffusion_planner
#endif  // AUTOWARE__DIFFUSION_PLANNER__PREPROCESSING__INPUT_BUILDER_HPP_

...
#ifndef AUTOWARE__DIFFUSION_PLANNER__PREPROCESSING__ITEMS__TRAFFIC_SIGNALS_HPP_
#define AUTOWARE__DIFFUSION_PLANNER__PREPROCESSING__ITEMS__TRAFFIC_SIGNALS_HPP_
